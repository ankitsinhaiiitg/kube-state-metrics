	...
	cases := []generateMetricsTestCase{
		// Verify phase enumerations.
		{
			...
			Want: `
				...
				# HELP kube_persistentvolumeclaim_resized_status_condition Information about the status of resizing of persistent volume claim.
				...
				# TYPE kube_persistentvolumeclaim_resized_status_condition gauge
				...
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="false",type="CustomizedType"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="false",type="FileSystemResizePending"} 1
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="false",type="Resizing"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="true",type="CustomizedType"} 1
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="true",type="FileSystemResizePending"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="true",type="Resizing"} 1
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="unknown",type="CustomizedType"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="unknown",type="FileSystemResizePending"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="default",persistentvolumeclaim="mysql-data",status="unknown",type="Resizing"} 0
`,
			MetricNames: []string{"kube_persistentvolumeclaim_info", "kube_persistentvolumeclaim_status_phase", "kube_persistentvolumeclaim_resource_requests_storage_bytes", "kube_persistentvolumeclaim_labels", "kube_persistentvolumeclaim_access_mode", "kube_persistentvolumeclaim_resized_status_condition"},
		},
		{
			Obj: &v1.PersistentVolumeClaim{
				ObjectMeta: metav1.ObjectMeta{
		...
		},
		{
			...
			Want: `
				...
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="false",type="CustomizedType"} 1
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="false",type="FileSystemResizePending"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="false",type="Resizing"} 1
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="true",type="CustomizedType"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="true",type="FileSystemResizePending"} 1
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="true",type="Resizing"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="unknown",type="CustomizedType"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="unknown",type="FileSystemResizePending"} 0
				kube_persistentvolumeclaim_resized_status_condition{namespace="",persistentvolumeclaim="mongo-data",status="unknown",type="Resizing"} 0
`,
			MetricNames: []string{"kube_persistentvolumeclaim_info", "kube_persistentvolumeclaim_status_phase", "kube_persistentvolumeclaim_resource_requests_storage_bytes", "kube_persistentvolumeclaim_labels", "kube_persistentvolumeclaim_access_mode", "kube_persistentvolumeclaim_resized_status_condition"},
		},
	}
